              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    Email cannot be changed from the frontend.
                  </p>
                </div>
                <div>
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                {[
                  ...
                  },
                  {
                    ...
                    desc: 'Show desktop push notifications',
                    state: browserNotifs,
                    set: setBrowserNotifs,
                  },
                ].map((n) => {
                  const Icon = n.icon;
                  return (
                    <div key={n.label} className="flex items-center justify-between gap-4">
                      ...
                      >
                        <div
                          className={`absolute top-1 size-4 rounded-full bg-white shadow transition-transform ${n.state ? 'translate-x-5' : 'translate-x-1'}`}
                        />
                      </div>
                    </div>
                  );
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                <div>
                  ...
                  <input
                    type="password"
                    placeholder="••••••••"
                    className="h-10 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm outline-none focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
                  <p className="text-xs text-amber-700">
                    Password changes require a backend API endpoint (not yet implemented). These
                    fields are for UI demonstration.
                  </p>
                </div>
                <button
                  className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white transition hover:opacity-90 cursor-pointer"
